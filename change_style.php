<?php
	...
	if (isset($_POST['saada'])) {
		...
		$_SESSION['line_with']= $_POST['line_with'];
		$_SESSION['line_style']= $_POST['line_style'];
		$_SESSION['line_color']= $_POST['line_color'];
		$_SESSION['line_radius']= $_POST['line_radius'];
		}
...
<form method="POST" action="change_style.php">
	...
	<button type="submit" name=saada >Uuenda</button>
</form>
